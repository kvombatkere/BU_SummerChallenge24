...
# Constants for Game configuration - Do not change
WIDTH, HEIGHT = 633, 900

SCREEN = pygame.display.set_mode((WIDTH, HEIGHT))
BACKGROUND = pygame.image.load("assets/wordle_starting_tiles.png")
...
LETTER_Y_SPACING = 12
LETTER_SIZE = 75
#Pygame code to render graphics
class Letter:
...
def create_new_letter(key_press):
    # Creates a new letter and adds it to the guess.
    global current_guess_string, current_letter_bg_x
    
    current_guess_string += key_press
    new_letter = Letter(key_press, (current_letter_bg_x, guesses_count*100+LETTER_Y_SPACING))
